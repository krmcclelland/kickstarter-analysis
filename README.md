...
1. [Analysis and Conclusions](#analysis-and-conclusions)
    1. [Dataset](#dataset)
    1. [Outcome Analysis Using Launch Dates](#outcome-analysis-using-launch-dates)
    1. [Edinburgh Plays Analysis](#edinburgh-plays-analysis)
...
## Outcome Analysis Using Launch Dates <a name="outcome-analysis-using-launch-dates"></a>
